...
export const generateArticle = async (req, res) => {
  try {
    ...
    console.log(userId, prompt, length, plan, free_usage);
...
export const generateImage = async (req, res) => {
  try {
    ...
    if (plan !== "premium") {
      return res.json({
        success: false,
        message: "This feature only available for premium subscriptions ",
      });
    }
...
export const resumeReview = async (req, res) => {
  try {
    ...
    // AI PROMPT
    const prompt = `
      Review the following resume and provide a constructive analysis 
      including strengths, weaknesses, clarity, formatting, impact, 
